...
export default function JurnalKas({ journals = [], periods = [], initialFilters = {} }) {
  ...
  const handleSearch = () => {
    ...
    router.get(route('jurnal.kas'), query, {
        preserveState: true,
        preserveScroll: true,
    });
  };
    ...
    <>
      ...
      <AppLayouts breadcrumbs={breadcrumbs}>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                <h1 className="text-2xl font-bold">Jurnal Kas</h1>
                <p className="text-muted-foreground">
                Berikut adalah daftar semua jurnal kas yang telah tercatat.
                </p>
            </div>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem asChild>
                        <Link href={route('jurnal.kas.pemasukan.create')}>Pemasukan Kas</Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild>
                        <Link href={route('jurnal.kas.pengeluaran.create')}>Pengeluaran Kas</Link>
                    </DropdownMenuItem>
                </DropdownMenuContent>
            </DropdownMenu>
          </div>

          <Tabs value="/jurnal/kas" onValueChange={handleTabChange}>
            <TabsList>
          ...
          <Card>
            <CardHeader className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div>
                <CardTitle>Daftar Jurnal Kas</CardTitle>
                <CardDescription>
                    Anda dapat mencari, memfilter, dan mengelola jurnal kas dari
                    sini.
                </CardDescription>
              </div>
                          ...
                          <TableCell className="text-right">
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem asChild>
                                  <Link href={journal.journal_type === 'Pemasukan Kas' ? route('jurnal.kas.pemasukan.edit', journal.id) : route('jurnal.kas.pengeluaran.edit', journal.id)}>
                                    Edit
                                  </Link>
                                </DropdownMenuItem>
                                <DropdownMenuItem 
