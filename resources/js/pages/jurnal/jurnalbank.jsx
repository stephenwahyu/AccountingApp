...
export default function JurnalBank({ journals = [], periods = [], initialFilters = {} }) {
  ...
  const handleSearch = () => {
    ...
    router.get(route('jurnal.bank'), query, {
        preserveState: true,
        preserveScroll: true,
    });
  };
                          ...
                          <TableCell className="text-right">
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem asChild>
                                  <Link href={journal.journal_type === 'Pemasukan Bank' ? route('jurnal.bank.pemasukan.edit', journal.id) : route('jurnal.bank.pengeluaran.edit', journal.id)}>
                                    Edit
                                  </Link>
                                </DropdownMenuItem>
                                <DropdownMenuItem 
