...
const breadcrumbs = [
  ...
  { title: "Semua", href: "/jurnal" },
];

// Tab navigation component
const JurnalTabs = ({ activeTab = "semua" }) => {
  const tabs = [
      ...
      <AppLayouts breadcrumbs={breadcrumbs}>
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Semua</p>
          </div>

          {/* Tabs */}
          <JurnalTabs activeTab="semua" />
              ...
              <table className="w-full">
                <thead className="bg-muted/50">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-sm font-medium">Tanggal Jurnal</th>
                    <th className="px-4 py-3 text-left text-sm font-medium">Periode</th>
                    <th className="px-4 py-3 text-left text-sm font-medium">Tipe Jurnal</th>
