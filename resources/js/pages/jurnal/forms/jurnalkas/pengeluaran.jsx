          ...
          <div className="flex flex-col gap-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Atur data administratif dan akun kas sumber dana.</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        ...
                        <div className="grid gap-2 lg:col-span-2">
                            <div className="flex flex-col gap-3 md:items-center md:flex-row">
                                <div className="grid gap-2">
                            <Label htmlFor="cash_account_id" className="text-xs uppercase tracking-wider text-muted-foreground">Ambil dari Akun Kas</Label>
                            <Select
            ...
            <Card className="overflow-hidden border-primary/10 shadow-md">
                <CardHeader className="bg-muted/20 pb-4 border-b">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <CardDescription>Tentukan akun-akun beban atau liabilitas sebagai tujuan pengeluaran kas.</CardDescription>
                        </div>
                        <Button
                            type="button"
                            variant="outline"
                ...
                <CardFooter className="flex flex-col sm:flex-row justify-between gap-6 items-stretch sm:items-center bg-muted/30 py-6 px-6 border-t">
                    <div className="flex flex-col gap-1">
                        <p className="text-xs uppercase font-semibold text-muted-foreground">Akun Kas Sumber</p>
