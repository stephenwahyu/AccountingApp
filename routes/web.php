...
Route::middleware('auth')->group(function () {
    ...
    // Jurnal Routes
    Route::prefix('jurnal')->name('jurnal.')->middleware('can:manage-accounting')->group(function () {
        // Semua Jurnal
    ...
    Route::prefix('bagan-perkiraan')->name('bagan-perkiraan.')->middleware('can:manage-accounting')->group(function () {
    ...
    Route::prefix('periode')->name('periode.')->middleware('can:manage-accounting')->group(function () {
