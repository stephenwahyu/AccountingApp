...
class AccountSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('accounts')->insert([
            ...
            // ════════════════════════════════════════════════════
            [
                'id' => 1, 'account_code' => '1-1000', 'account_name' => 'ASET LANCAR',
                'account_category_id' => 1, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => null,
                'initial_balance' => 0.00, // Akun group — tidak memiliki saldo langsung
            ],

            // ── Kas & Bank ──────────────────────────────────────
            [
                'id' => 2, 'account_code' => '1-1100', 'account_name' => 'Kas & Bank',
                'account_category_id' => 1, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => 1,
                'initial_balance' => 0.00, // Akun group
            ],
            [
                'id' => 3, 'account_code' => '1-1101', 'account_name' => 'Kas Kecil',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 1, 'parent_id' => 2,
                // Tidak ada padanan Kas Kecil di aplikasi lama (101.102 & 101.103 = 0)
                'initial_balance' => 0.00,
            ],
            [
                'id' => 4, 'account_code' => '1-1102', 'account_name' => 'Kas Besar',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 1, 'parent_id' => 2,
            ...
            [
                'id' => 5, 'account_code' => '1-1103', 'account_name' => 'Bank BCA',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 1, 'parent_id' => 2,
            ...
            [
                'id' => 6, 'account_code' => '1-1104', 'account_name' => 'Bank Mandiri',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 1, 'parent_id' => 2,
            ...
            [
                'id' => 7, 'account_code' => '1-1105', 'account_name' => 'Bank BNI',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 1, 'parent_id' => 2,
            ...
            // ── Piutang ─────────────────────────────────────────
            [
                'id' => 8, 'account_code' => '1-1200', 'account_name' => 'Piutang',
                'account_category_id' => 1, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => 1,
                'initial_balance' => 0.00, // Akun group
            ],
            [
                'id' => 9, 'account_code' => '1-1201', 'account_name' => 'Piutang Usaha',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 8,
                // Lama: 103.xxx Piutang — semua saldo = 0
                'initial_balance' => 0.00,
            ],
            [
                'id' => 10, 'account_code' => '1-1202', 'account_name' => 'Piutang Karyawan',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 8,
            ...
            [
                'id' => 11, 'account_code' => '1-1203', 'account_name' => 'Piutang Lain-Lain',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 8,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 12, 'account_code' => '1-1204', 'account_name' => 'Cadangan Kerugian Piutang',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 8,
            ...
            // ── Persediaan ──────────────────────────────────────
            [
                'id' => 13, 'account_code' => '1-1300', 'account_name' => 'Persediaan',
                'account_category_id' => 1, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => 1,
                'initial_balance' => 0.00, // Akun group
            ],
            [
                'id' => 14, 'account_code' => '1-1301', 'account_name' => 'Persediaan Barang Dagang',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 13,
                // Tidak ada akun persediaan barang dengan saldo di aplikasi lama
                'initial_balance' => 0.00,
            ],
            [
                'id' => 15, 'account_code' => '1-1302', 'account_name' => 'Persediaan Barang Dalam Transit',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 13,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 16, 'account_code' => '1-1303', 'account_name' => 'Persediaan Bahan Kemasan',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 13,
                'initial_balance' => 0.00,
            ],
            ...
            // ── Aset Lancar Lainnya ──────────────────────────────
            [
                'id' => 17, 'account_code' => '1-1400', 'account_name' => 'Aset Lancar Lainnya',
                'account_category_id' => 1, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => 1,
                'initial_balance' => 0.00, // Akun group
            ],
            [
                'id' => 18, 'account_code' => '1-1401', 'account_name' => 'Biaya Dibayar Dimuka',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 17,
                // Lama: 106.090 Lain-lain dibayar dimuka — saldo = 0
                'initial_balance' => 0.00,
            ],
            [
                'id' => 19, 'account_code' => '1-1402', 'account_name' => 'Asuransi Dibayar Dimuka',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 17,
            ...
            [
                'id' => 20, 'account_code' => '1-1403', 'account_name' => 'Sewa Dibayar Dimuka',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 17,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 21, 'account_code' => '1-1404', 'account_name' => 'PPN Masukan',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 17,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 22, 'account_code' => '1-1405', 'account_name' => 'Uang Muka Pembelian',
                'account_category_id' => 1, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 17,
            ...
            // ════════════════════════════════════════════════════
            [
                'id' => 23, 'account_code' => '1-2000', 'account_name' => 'ASET TETAP',
                'account_category_id' => 2, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => null,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 24, 'account_code' => '1-2100', 'account_name' => 'Tanah',
                'account_category_id' => 2, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => 23,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 25, 'account_code' => '1-2101', 'account_name' => 'Tanah Kantor',
                'account_category_id' => 2, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 24,
                // Lama: 112.101 Tanah — saldo = 0
                'initial_balance' => 0.00,
            ],
            [
                'id' => 26, 'account_code' => '1-2102', 'account_name' => 'Tanah Gudang',
                'account_category_id' => 2, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 24,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 27, 'account_code' => '1-2200', 'account_name' => 'Bangunan',
                'account_category_id' => 2, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => 23,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 28, 'account_code' => '1-2201', 'account_name' => 'Bangunan Kantor',
                'account_category_id' => 2, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 27,
                // Lama: 112.102 Bangunan — saldo = 0
                'initial_balance' => 0.00,
            ],
            [
                'id' => 29, 'account_code' => '1-2202', 'account_name' => 'Bangunan Gudang',
                'account_category_id' => 2, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 27,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 30, 'account_code' => '1-2203', 'account_name' => 'Bangunan Toko',
                'account_category_id' => 2, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 27,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 31, 'account_code' => '1-2210', 'account_name' => 'Akumulasi Penyusutan Bangunan',
                'account_category_id' => 2, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 27,
                // Lama: 112.201 Akumulasi Peny. Bangunan — saldo = 0
                'initial_balance' => 0.00,
            ],
            [
                'id' => 32, 'account_code' => '1-2300', 'account_name' => 'Kendaraan',
                'account_category_id' => 2, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => 23,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 33, 'account_code' => '1-2301', 'account_name' => 'Kendaraan Operasional',
                'account_category_id' => 2, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 32,
                // Lama: 112.103 & 112.111 Kendaraan — saldo = 0
                'initial_balance' => 0.00,
            ],
            [
                'id' => 34, 'account_code' => '1-2302', 'account_name' => 'Kendaraan Pengiriman',
                'account_category_id' => 2, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 32,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 35, 'account_code' => '1-2310', 'account_name' => 'Akumulasi Penyusutan Kendaraan',
                'account_category_id' => 2, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 32,
            ...
            [
                'id' => 36, 'account_code' => '1-2400', 'account_name' => 'Peralatan & Mesin',
                'account_category_id' => 2, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => 23,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 37, 'account_code' => '1-2401', 'account_name' => 'Peralatan Kantor',
                'account_category_id' => 2, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 36,
                // Lama: 112.104 & 112.110 Inventaris Kantor — saldo = 0
                'initial_balance' => 0.00,
            ],
            [
                'id' => 38, 'account_code' => '1-2402', 'account_name' => 'Komputer & Printer',
                'account_category_id' => 2, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 36,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 39, 'account_code' => '1-2403', 'account_name' => 'Peralatan Gudang',
                'account_category_id' => 2, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 36,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 40, 'account_code' => '1-2404', 'account_name' => 'Furniture & Fixture',
                'account_category_id' => 2, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 36,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 41, 'account_code' => '1-2410', 'account_name' => 'Akumulasi Penyusutan Peralatan',
                'account_category_id' => 2, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 36,
            ...
            // ════════════════════════════════════════════════════
            [
                'id' => 42, 'account_code' => '1-3000', 'account_name' => 'ASET LAINNYA',
                'account_category_id' => 3, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => null,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 43, 'account_code' => '1-3101', 'account_name' => 'Investasi Jangka Panjang',
                'account_category_id' => 3, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 42,
                // Lama: 111.xxx Penyertaan Saham — semua saldo = 0
                'initial_balance' => 0.00,
            ],
            [
                'id' => 44, 'account_code' => '1-3102', 'account_name' => 'Aset Dalam Penyelesaian',
                'account_category_id' => 3, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 42,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 45, 'account_code' => '1-3103', 'account_name' => 'Goodwill',
                'account_category_id' => 3, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 42,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 46, 'account_code' => '1-3104', 'account_name' => 'Deposito Jangka Panjang',
                'account_category_id' => 3, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 42,
            ...
            // ════════════════════════════════════════════════════
            [
                'id' => 47, 'account_code' => '2-1000', 'account_name' => 'LIABILITAS JANGKA PENDEK',
                'account_category_id' => 4, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => null,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 48, 'account_code' => '2-1100', 'account_name' => 'Hutang',
                'account_category_id' => 4, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => 47,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 49, 'account_code' => '2-1101', 'account_name' => 'Hutang Usaha',
                'account_category_id' => 4, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 48,
                // Lama: 201.xxx Hutang Usaha — semua saldo = 0
                'initial_balance' => 0.00,
            ],
            [
                'id' => 50, 'account_code' => '2-1102', 'account_name' => 'Hutang Gaji',
                'account_category_id' => 4, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 48,
            ...
            [
                'id' => 51, 'account_code' => '2-1103', 'account_name' => 'Hutang Pajak',
                'account_category_id' => 4, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 48,
            ...
            [
                'id' => 52, 'account_code' => '2-1104', 'account_name' => 'Hutang Lain-Lain',
                'account_category_id' => 4, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 48,
            ...
            [
                'id' => 53, 'account_code' => '2-1200', 'account_name' => 'Hutang Bank Jangka Pendek',
                'account_category_id' => 4, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => 47,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 54, 'account_code' => '2-1201', 'account_name' => 'Hutang Bank BCA - Jangka Pendek',
                'account_category_id' => 4, 'cash_flow_activity_id' => 3,
                'is_cash_account' => 0, 'parent_id' => 53,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 55, 'account_code' => '2-1202', 'account_name' => 'Hutang Bank Mandiri - Jangka Pendek',
                'account_category_id' => 4, 'cash_flow_activity_id' => 3,
                'is_cash_account' => 0, 'parent_id' => 53,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 56, 'account_code' => '2-1300', 'account_name' => 'Kewajiban Jangka Pendek Lainnya',
                'account_category_id' => 4, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => 47,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 57, 'account_code' => '2-1301', 'account_name' => 'PPN Keluaran',
                'account_category_id' => 4, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 56,
                // Lama: 204.001 / 204.030 Hutang PPN — saldo = 0
                'initial_balance' => 0.00,
            ],
            [
                'id' => 58, 'account_code' => '2-1302', 'account_name' => 'PPh Pasal 21',
                'account_category_id' => 4, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 56,
            ...
            [
                'id' => 59, 'account_code' => '2-1303', 'account_name' => 'PPh Pasal 23',
                'account_category_id' => 4, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 56,
            ...
            [
                'id' => 60, 'account_code' => '2-1304', 'account_name' => 'PPh Pasal 4 ayat 2',
                'account_category_id' => 4, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 56,
            ...
            [
                'id' => 61, 'account_code' => '2-1305', 'account_name' => 'Biaya Yang Masih Harus Dibayar',
                'account_category_id' => 4, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 56,
            ...
            [
                'id' => 62, 'account_code' => '2-1306', 'account_name' => 'Pendapatan Diterima Dimuka',
                'account_category_id' => 4, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 56,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 63, 'account_code' => '2-1307', 'account_name' => 'Uang Muka Pelanggan',
                'account_category_id' => 4, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 56,
                'initial_balance' => 0.00,
            ],
            ...
            // ════════════════════════════════════════════════════
            [
                'id' => 64, 'account_code' => '2-2000', 'account_name' => 'LIABILITAS JANGKA PANJANG',
                'account_category_id' => 5, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => null,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 65, 'account_code' => '2-2101', 'account_name' => 'Hutang Bank Jangka Panjang',
                'account_category_id' => 5, 'cash_flow_activity_id' => 3,
                'is_cash_account' => 0, 'parent_id' => 64,
                // Lama: 206.100 Hutang Bank Riau Kepri Syariah — saldo = 0
                'initial_balance' => 0.00,
            ],
            [
                'id' => 66, 'account_code' => '2-2102', 'account_name' => 'Hutang Obligasi',
                'account_category_id' => 5, 'cash_flow_activity_id' => 3,
                'is_cash_account' => 0, 'parent_id' => 64,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 67, 'account_code' => '2-2103', 'account_name' => 'Hutang Sewa Pembiayaan (Leasing)',
                'account_category_id' => 5, 'cash_flow_activity_id' => 3,
                'is_cash_account' => 0, 'parent_id' => 64,
            ...
            // ════════════════════════════════════════════════════
            [
                'id' => 68, 'account_code' => '3-0000', 'account_name' => 'EKUITAS',
                'account_category_id' => 6, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => null,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 69, 'account_code' => '3-1001', 'account_name' => 'Modal Saham',
                'account_category_id' => 6, 'cash_flow_activity_id' => 3,
                'is_cash_account' => 0, 'parent_id' => 68,
                // Lama: 300.010–300.130 Modal — semua saldo = 0
                'initial_balance' => 0.00,
            ],
            [
                'id' => 70, 'account_code' => '3-1002', 'account_name' => 'Tambahan Modal Disetor',
                'account_category_id' => 6, 'cash_flow_activity_id' => 3,
                'is_cash_account' => 0, 'parent_id' => 68,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 71, 'account_code' => '3-2001', 'account_name' => 'Laba Ditahan',
                'account_category_id' => 6, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => 68,
            ...
            [
                'id' => 72, 'account_code' => '3-2002', 'account_name' => 'Laba Tahun Berjalan',
                'account_category_id' => 6, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => 68,
            ...
            [
                'id' => 73, 'account_code' => '3-3001', 'account_name' => 'Prive/Dividen',
                'account_category_id' => 6, 'cash_flow_activity_id' => 3,
                'is_cash_account' => 0, 'parent_id' => 68,
                'initial_balance' => 0.00,
            ],
            ...
            // ════════════════════════════════════════════════════
            [
                'id' => 74, 'account_code' => '4-1000', 'account_name' => 'PENDAPATAN USAHA',
                'account_category_id' => 7, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => null,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 75, 'account_code' => '4-1001', 'account_name' => 'Penjualan',
                'account_category_id' => 7, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 74,
                'initial_balance' => 0.00, // Akun L/R — selalu 0 saat awal periode
            ],
            [
                'id' => 76, 'account_code' => '4-1002', 'account_name' => 'Retur Penjualan',
                'account_category_id' => 7, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 74,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 77, 'account_code' => '4-1003', 'account_name' => 'Potongan Penjualan',
                'account_category_id' => 7, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 74,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 78, 'account_code' => '4-1004', 'account_name' => 'Diskon Penjualan',
                'account_category_id' => 7, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 74,
                'initial_balance' => 0.00,
            ],
            ...
            // ════════════════════════════════════════════════════
            [
                'id' => 79, 'account_code' => '4-2000', 'account_name' => 'PENDAPATAN LAIN-LAIN',
                'account_category_id' => 8, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => null,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 80, 'account_code' => '4-2001', 'account_name' => 'Pendapatan Bunga',
                'account_category_id' => 8, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 79,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 81, 'account_code' => '4-2002', 'account_name' => 'Keuntungan Selisih Kurs',
                'account_category_id' => 8, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 79,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 82, 'account_code' => '4-2003', 'account_name' => 'Pendapatan Sewa',
                'account_category_id' => 8, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 79,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 83, 'account_code' => '4-2004', 'account_name' => 'Keuntungan Penjualan Aset',
                'account_category_id' => 8, 'cash_flow_activity_id' => 2,
                'is_cash_account' => 0, 'parent_id' => 79,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 84, 'account_code' => '4-2005', 'account_name' => 'Pendapatan Lain-Lain',
                'account_category_id' => 8, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 79,
                'initial_balance' => 0.00,
            ],
            ...
            // ════════════════════════════════════════════════════
            [
                'id' => 85, 'account_code' => '5-1000', 'account_name' => 'HARGA POKOK PENJUALAN',
                'account_category_id' => 9, 'cash_flow_activity_id' => null,
                'is_cash_account' => 0, 'parent_id' => null,
                'initial_balance' => 0.00,
            ],
            [
                'id' => 86, 'account_code' => '5-1001', 'account_name' => 'Pembelian Barang Dagang',
                'account_category_id' => 9, 'cash_flow_activity_id' => 1,
                'is_cash_account' => 0, 'parent_id' => 85,
